...
const page = () => {
  return (
    ...
    >
      <h3 className="font-dynapuff text-lg md:text-xl lg:text-2xl font-semibold mb-4 text-center">
        Contact Us
      </h3>

      <p className="text-lg md:text-xl lg:text-xl font-semibold text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
        ...
        <div className="flex flex-col justify-center items-center gap-3 border border-gray-300 rounded-xl p-4 hover:shadow-lg hover:border-green-400 transition-shadow duration-300 cursor-pointer">
          ...
          <p className="text-purple-500 hover:underline hover:text-purple-600">
            Available 24/7
          </p>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p>
                  ...
                  urgent matters, please use our live chat or call our support
                  line.
                </p>
              </div>
            </div>
          ...
          <div className="border border-gray-300 rounded-xl p-4 mt-4">
            ...
            <div className="mt-4 space-y-4">
              ...
              <div className="flex flex-col justify-between gap-1">
                ...
                <p className="text-sm">
                  456 Madison Avenue, 10th Floor, NY 10022
                </p>
                <p className="text-sm hover:underline font-semibold">
                  +1 (555) 987-6543
                </p>
