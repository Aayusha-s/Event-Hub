...
export default function VendorEventDetails({
  ...
  return (
    <section className="my-4 mx-2 px-4 font-cause text-text-dark md:mx-3 lg:mx-4 xl:mx-6">
      ...
      {data && (
        <article className="mt-6 overflow-hidden rounded-xl border border-brown-normal">
          <div className="h-64 bg-brown-light">
            {data.event.images?.[0] && (
              <img
          ...
          <div className="p-5 md:p-8">
            ...
            <div className="mt-6 grid gap-4 rounded-xl bg-brown-light p-4 md:grid-cols-2">
              ...
              <p>
                ...
                <b>Location:</b>{" "}
                {data.event.isOnline ? "Online event" : data.event.venue}
              </p>
              <p>
                <b>Organizer:</b>{" "}
