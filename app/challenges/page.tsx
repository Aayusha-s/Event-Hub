  ...
  return (
    ...
    >
      <div className="w-full border border-brown-normal rounded-xl p-4 space-y-4">
        <h3 className="font-dynapuff text-center text-lg md:text-xl lg:text-2xl font-semibold">
          {" "}
          Level Up Your Experience
        </h3>
        <p className="text-center text-lg md:text-xl lg:text-xl font-semibold">
          Complete challenges, earn badges, and redeem amazing rewards
        </p>
        ...
        <>
          <div className="flex flex-col border border-brown-normal rounded-xl p-4 mt-6">
            <div className="flex flex-row gap-4 items-center">
              ...
              <div>
                <h3 className="font-dynapuff text-md md:text-xl lg:text-2xl font-semibold">
                  {" "}
                  Daily Challenges
                </h3>
          ...
          <div className="flex flex-col border border-brown-normal rounded-xl p-4 mt-6">
            <h3 className="font-bold mb-6 text-lg md:text-xl lg:text-xl">
              Active Challenges
            </h3>
      ...
      {activeTab === "leaderboard" && (
        <>
          <div className="flex flex-col gap-4 border border-brown-normal rounded-xl p-4 mt-6">
            <h3 className="font-bold text-lg md:text-xl lg:text-xl">
              Leaderboard
            </h3>
